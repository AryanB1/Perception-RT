...
StatSnapshot MetricsRegistry::snapshot(double /*window_secs*/) const {
  StatSnapshot s{};
  s.pre_p50 = pre_.perc(50);
  s.pre_p95 = pre_.perc(95);
  s.pre_p99 = pre_.perc(99);
  s.inf_p50 = inf_.perc(50);
  s.inf_p95 = inf_.perc(95);
  s.inf_p99 = inf_.perc(99);
  s.post_p50 = post_.perc(50);
  s.post_p95 = post_.perc(95);
  s.post_p99 = post_.perc(99);
  s.e2e_p50 = e2e_.perc(50);
  s.e2e_p95 = e2e_.perc(95);
  s.e2e_p99 = e2e_.perc(99);
